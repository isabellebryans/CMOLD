...
public class cashRegistry1 {
    public static void main(String[] args) throws FileNotFoundException, IOException {
        System.out.println("Hello world!");

        Graph dataGraph = loadData.initAndLoadModelFromFolder("src/main/java/org/example/Chess/type2/ChessMove_type1.ttl", Lang.TURTLE).getGraph();
